...
extern int connectByPE_grad ( gzFile * fp, int peGrad, char * line );
...
extern void delowHighArc(int multi);
extern int deleteLightArc();
extern void output_1contig (int id, EDGE * edge, FILE * fp, boolean tip);

//mao
extern void divideComponent(char *outfile);
extern void loadReadPath (char * graphfile);
extern int  getComponent (char * graphfile);
extern void findAllPath ();
extern void outputAllPath (char * graphfile);
extern void deleteSimpleLoop();
